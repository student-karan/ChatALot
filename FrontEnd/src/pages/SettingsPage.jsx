...
const SettingsPage = () => {
  const { theme, changeTheme } = selectTheme();

  return (
    <div className="w-full h-full flex items-center justify-center px-4 sm:px-20 pt-20">
                ...
                <div className="bg-base-100 rounded-xl shadow-sm overflow-hidden">
                  ...
                  <div className="p-4 space-y-4 min-h-[200px] max-h-[200px] overflow-y-auto bg-base-100">
                    {PREVIEW_MESSAGES.map((message, idx) => (
                      <div key={idx} className={`flex ${message.isSent ? "justify-end" : "justify-start"}`}>
                        ...
                        `} >
                          ...
                          <p className={`text-[10px] mt-1.5 ${message.isSent ? "text-primary-content/70" : "text-base-content/70"}`}>
                            {message.isSent ? "12:02 PM" : "11:58 PM"}
                          </p>
                        </div>
                      </div>
                    ))}
